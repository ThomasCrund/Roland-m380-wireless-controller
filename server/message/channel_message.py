...
class ChannelMessage(SysExcMessage):
  ...
  def get_all_interpreters() -> ChannelMessage:
    ...
    messages = [
      ChannelMessage(ChannelProperty([0x00, 0x00], 6, "name"), [65] * 6, channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x06], 1, "name_color", (0, 7)), [0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x08], 1, "link", (0, 1)), [0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x09], 1, "phase", (0, 1)), [0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x0A], 2, "att"), [0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x0C], 1, "mute", (0, 1)), [1], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x0D], 1, "solo", (0, 1)), [0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x0E], 2, "fader"), [64, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x10], 1, "pan", (1, 0x7F)), [65], channelId, MessageDirection.INTERPRETER),
      ...
      ChannelMessage(ChannelProperty([0x00, 0x50], 1, "eq_switch", (0, 1)), [0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x51], 2, "eq_att"), [0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x53], 2, "lo_gain"), [0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x55], 3, "lo_freq"), [0, 0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x58], 2, "lo_mid_gain"), [0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x5A], 3, "lo_mid_freq"), [0, 0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x5D], 2, "lo_mid_q"), [0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x5F], 2, "hi_mid_gain"), [0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x61], 3, "hi_mid_freq"), [0, 0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x64], 2, "hi_mid_q"), [0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x66], 2, "hi_gain"), [0, 0], channelId, MessageDirection.INTERPRETER),
      ChannelMessage(ChannelProperty([0x00, 0x68], 3, "hi_freq"), [0, 0, 0], channelId, MessageDirection.INTERPRETER),
    ]

    for aux_num in range(1, 16):
      start_address = 8 * (aux_num - 1)
      messages += [
        ChannelMessage(ChannelProperty([0x01, start_address + 0], 1, f'aux{aux_num}_switch', (0, 1)), [0], channelId, MessageDirection.INTERPRETER),
        ChannelMessage(ChannelProperty([0x01, start_address + 1], 1, f'aux{aux_num}_position', (0, 2)), [0], channelId, MessageDirection.INTERPRETER),
        ChannelMessage(ChannelProperty([0x01, start_address + 2], 2, f'aux{aux_num}_level'), [64, 0], channelId, MessageDirection.INTERPRETER),
        ChannelMessage(ChannelProperty([0x01, start_address + 4], 1, f'aux{aux_num}_pan', (1, 0x7F)), [0], channelId, MessageDirection.INTERPRETER),
        ChannelMessage(ChannelProperty([0x01, start_address + 5], 1, f'aux{aux_num}_pan_link', (0, 1)), [0], channelId, MessageDirection.INTERPRETER),
      ]
